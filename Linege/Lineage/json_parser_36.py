...
class URLParseRequest(BaseModel):
    ...
    name: Optional[str] = Field(None, description="Filter by top-level name field", example="rhoo_controls_field_sql_query")
...
class FileParseRequest(BaseModel):
    ...
    name: Optional[str] = Field(None, description="Filter by top-level name field")
