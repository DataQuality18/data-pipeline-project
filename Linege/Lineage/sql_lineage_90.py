        ...
        for sql_file in sql_files:
            ...
            try:
                ...
                if query_type in ['Mongo', 'Elastic']:
                    lineage_data = [self._create_non_sql_record(query_type, query_key, sql_file, metadatakey, regulation, class_name)]
                    print(f"SUCCESS: Detected {query_type} Query")
                else:
                    lineage_data = self.parse_single_sql(sql_content, sql_file, query_key, sql_file, metadatakey, regulation, class_name)
