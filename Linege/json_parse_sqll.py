...
class JSONSQLParser:
    ...
    def parse_from_url(
        ...
        try:
            ...
            results = self._process_data_structure(
                data, "url", regulation, classname, view_names
            )
    ...
    def _parse_single_json(
        ...
        try:
            ...
            return self._process_data_structure(data, file_name, regulation, classname, view_names)
    ...
    def _process_data_structure(
        ...
        for idx, item in enumerate(items, 1):
            ...
            item_results = self._parse_single_data_object(
                item, item_source, regulation, classname, view_names
            )
...
def _process_lineage(results: List[Dict]) -> List[Dict[str, str]]:
    ...
    Args:
        results: List of dictionaries containing sql_query, view_name, classname, regulation
...
def api_parse_lineage_from_url(request: URLParseRequest):
    ...
    classname and regulation metadata.
    """
    try:
